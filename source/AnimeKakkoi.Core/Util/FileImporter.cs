...
namespace AnimeKakkoi.Core.Util
{
    ...
    public class FileManager : IImporter
    {
        ...
        public Entities.EntityState ElementState { get; set; }
        ...
        public void Save()
        {
            ...
            try
            {
                ...
                {
                    zip.PackageProperties.Creator = IO.AkConfiguration.APPLICATION_NAME;
                    zip.PackageProperties.Description = IO.AkConfiguration.APPLICATION_NAME + "'s Sharing file.";
                    ...
                    {
                        buffer.AppendLine(String.Format("!{0}{1}{0}{2}{0}{3}", SEPARATOR_CHAR, obj.GetType(), (obj as Entities.EntitySource).ToString(), (obj as Entities.EntitySource).ProgressString));
                    }
        ...
        private void CheckForStateChange()
        {
            ...
            if (Enum.IsDefined(typeof(Entities.EntityState), ElementState))
            {
                try
                {
                    foreach (Entities.EntitySource item in this.Elements)
